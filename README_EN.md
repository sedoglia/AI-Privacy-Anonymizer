...
```bash
# Step 1 — Install the base package (ML, PDF, Office, Web UI, REST API)
pip install "ai-privacy-anonymizer[recommended]"

# Step 2 — Install OPF: Layer 1 of the pipeline, maximum PII coverage (recommended, ~3 GB)
pip install "opf @ git+https://github.com/openai/privacy-filter"
# Alternatively, both steps in one command:
